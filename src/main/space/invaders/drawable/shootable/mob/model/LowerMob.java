...
import static main.space.invaders.settings.MobDisplay.LOWER_MOB_HITBOX_DIFFERENCE_X;
import static main.space.invaders.settings.MobDisplay.LOWER_MOB_HITBOX_DIFFERENCE_Y;
import static main.space.invaders.settings.MobDisplay.MOB_SIZE;

public class LowerMob extends Mob {

    public LowerMob(Image stay, Image go, int xLocation, int yLocation) {
